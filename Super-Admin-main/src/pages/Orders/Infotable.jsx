                ...
                <tbody>
                  {currentData.map((d, index) => (
                    ...
                    >
                      ...
                      <td className="pl-10">{d.order_id}</td>
                      ...
                      <td className="pl-12">{d.vendor_name}</td>
                      <td className="pl-10">{d.quantity}</td>
                      <td className="pl-8">{d.price}</td>
