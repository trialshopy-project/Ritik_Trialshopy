              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-white border-b-2">
                    ...
                    <th className="pr-9">Payment Method</th>
                    <th className="pr-9">Revenue</th>
                    <th className="pr-9 ">Price</th>
                    <th className="pr-9">Payment</th>
                    <th className="pr-9">quantity</th>
                ...
                <tbody>
                  {currentData.map((d, index) => (
                    ...
                    >
                      ...
                      <td className="pl-12">{d.payment_method}</td>
                      <td className="pl-8">{d.revenue}</td>
                      <td className="pl-6">{d.price}</td>
                      <td className="pl-8">{d.payment}</td>
                      <td className="pl-8">{d.quantity}</td>
