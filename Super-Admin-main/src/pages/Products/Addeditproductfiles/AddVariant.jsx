    ...
    <div className="flex flex-col lg:flex-row w-full justify-evenly items-start lg:items-center p-4 lg:p-8 space-y-6 lg:space-y-0 lg:space-x-6">
      <div className="w-full lg:w-[80%]">
        <div className="p-5 mt-5 bg-white rounded-lg shadow-lg">
          <h2 className="font-semibold text-center  flex items-center justify-center mb-5 text-black">
            Variants
          </h2>
          ...
          <button
            className="flex mt-5 bg-black justify-end rounded-full text-white items-end px-4 py-1 gap-2 focus:outline-none mb-3"
            type="button"
