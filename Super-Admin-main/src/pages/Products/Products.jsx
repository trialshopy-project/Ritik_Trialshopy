...
const Offers = () => {
  ...
  return (
    <div className="flex w-screen  lg:h-full h-screen overflow-y-scroll lg:w-full">
      ...
      <div className="  sm:w-full lg:ml-2 justify-center">
        <div className="flex flex-col md:flex-row justify-between md:scale-75% mt-16">
          {/* Search */}
          <div className="flex items-stretch m-4 bg-customGray focus:bg-gray-900 ">
            <input
              type="text"
        ...
        <div className="rounded-lg shadow  w-screen  lg:w-full">
          <div className="flex flex-row overflow-x-scroll w-full">
            <div className="px-8 pb-4 rounded-sm border border-gray-200">
              <div className="border-x w-full border-gray-200 rounded-sm overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="bg-white border-b-2">
                      <th className="mytable w-32 ms-4">S. No.</th>
                      <th className="w-32">
