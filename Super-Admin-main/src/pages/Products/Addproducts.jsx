...
// import SetColorProdcut from "./Addeditproductfiles/SetColorProdcut";
...
const Addproducts = () => {
  ...
  return (
    <div className="flex mt-14 w-screen lg:w-full lg:h-full h-screen overflow-y-scroll">
      <Topbar2 />

      <div className=" flex flex-col w-full">
        <div className="md:ml-20 flex items-center justify-between lg:ml-2 lg:w-full">
          ...
          <div className="flex mr-4">
            ...
            >
              <button className="flex bg-customGray py-2 text-white text-md items-center lg:px-4 ml-8 rounded-full focus:outline-none  ">
        ...
        {activeTab === 2 && (
          <>
            ...
            {/* <SetColorProdcut color={color} setColor={setColor} /> */}
        ...
        /> */}
          <div className="flex items-stretch m-5 mr-20 pr-20 gap-2 rounded-md cursor-pointer justify-end">
              <button
                onClick={() => setActiveTab(1)}
                className="flex  bg-black rounded-full text-white items-center px-4 py-1 gap-2 focus:outline-none mb-8"
              >
                Back
