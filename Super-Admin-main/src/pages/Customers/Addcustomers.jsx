  ...
  const handleCustomerAdd = async (e) => {
    ...
    try {
      const response = await axios.post(
        ...
        { name, email, phone_number, country, state, city },
        {
          headers: {
        ...
        <div className="bg-[#F1F1F1] mt-16">
          ...
          >
            ...
            <div className="flex gap-5 w-full">
              ...
              <div className="w-full">
                ...
                <select
                  value={country}
                  id=""
                  className=" border-0 border-b-2 py-2 w-3/4 lg:w-full"
            ...
            <div className="flex items-stretch m-5 focus:bg-gray-900">
              <button
                type="submit"
                className="flex bg-customGray text-white text-md items-center py-2 px-4 rounded-md focus:outline-none  "
              >
                Submit
