  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_ENDPOINT}/products/seller/${sellerId}?page=${currentPage}&limit=${limit}`
      );
                      ...
                      <tbody>
                        {data.map((d, index) => (
                          ...
                          >
                            ...
                            <td>
                              {d?.Size &&
                                Object.keys(d.Size).map((sizeKey) => (
                                  <div key={sizeKey} className="justify-between">
                                    <span className="font-bold text-customPurple">{sizeKey}</span>:{" "}
                                    
                                    <span>
                                      {d?.Size?.[sizeKey]?.trialshopyPrice ||
                                        d?.Size?.[sizeKey]?.defectivePrice ||
                                        "N/A"}
                                    </span>{" "}
                              ...
                              <div className="flex justify-center">
                                ...
                                {showConfirmation && (
                                  <Popup
                                    ...
                                    onConfirm={()=>handleProductDelete(showConfirmation)}
