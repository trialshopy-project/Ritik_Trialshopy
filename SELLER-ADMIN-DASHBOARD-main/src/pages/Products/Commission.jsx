...
const Commission = () => {
  ...
  const [datedFrom, setDatedFrom] = useState("");
  ...
  const fetchData = async () => {
    try {
      ...
      setOriginalData(response.data.commission);
    } catch (error) {
  ...
  return (
    <div className="flex w-screen lg:w-full  lg:h-full h-screen lg:overflow-hidden  overflow-y-scroll">
      {/* <Topbar2 /> */}
      <Header />
      <div>
        ...
        <div className="lg:ml-10 lg:mt-5 lg:flex   flex-col lg:flex-row w-full gap-2">
          <div className=" ml-4">
            <label className="block mb-2">
              Product ID <span className="text-[#F60002]">*</span>
            </label>
            <input
        ...
        <div className="flex items-stretch ml-5 mt-2 focus:bg-gray-900">
          ...
          <button
            ...
            className="bg-customPurple text-white font-bold lg:py-2 lg:px-4 px-2 py-2 rounded-r-md focus:outline-none"
          >
            <ion-icon name="search-outline" className="text-white"></ion-icon>
          </button>
        </div>

        <div className="mt-4 mr-8 overflow-x-scroll  lg:overflow-hidden ">
