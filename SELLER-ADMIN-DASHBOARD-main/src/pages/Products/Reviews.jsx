  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_ENDPOINT}/offers`
      );
              ...
              <div className="border-x border-gray-200 rounded-sm overflow-x-auto">
                <table className="w-full">
                  ...
                  {sellerData.length > 0 ? (
                      ...
                      <tbody>
                        {currentData.map((d, index) => (
                          ...
                          >
                            ...
                            <td>{d.discount}</td>
                            <td className="max-h-full overflow-auto">
                            ...
                            <td>
                              <div className="flex justify-center">
                                ...
                                <HiTrash
                                  ...
                                  onClick={() => handleDeleteOffer(d._id)}
                                />
                              </div>
                            </td>
                          </tr>
                    ...
                    <p className=" flex items-center justify-center m-auto mt-3">
                      DATA NOT FOUND
                    </p>
                  )}
                </table>
