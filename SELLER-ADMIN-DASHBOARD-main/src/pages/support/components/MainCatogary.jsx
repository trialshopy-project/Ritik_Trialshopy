      ...
      <div className='m-4'>
        ...
        <div className='m-4'>
            <div className='grid grid-cols-1 lg:grid-cols-3 sm:grid-cols-2'>
                ...
                <Category_box data={commonIssue} name={"Common Issue"}  logo={<BsReverseLayoutTextSidebarReverse/>}/>
            </div>
        </div>
        ...
        <div className='m-4'>
            <div className='grid grid-cols-1 lg:grid-cols-3 sm:grid-cols-2'>
                {/* <Categ_box title={"Something Another Issue"} logo={<BsReverseLayoutTextSidebarReverse/>}/> */}
