      ...
      <div className="p-4">
        <div className="flex flex-col md:flex-row md:justify-between items-center mb-4">
          <div className="flex flex-col md:flex-row md:space-x-4 mb-4 md:mb-0 w-full md:w-auto">
            <div className="border border-border rounded-md p-2 mb-2 md:mb-0 w-full md:w-auto">
              {" "}
              Filter by :
            </div>
          ...
          <button className="bg-orange-400 text-secondary-foreground hover:bg-secondary/80 p-2 rounded-md w-full md:w-auto">
            Download
          </button>
        </div>
