...
import { Form } from "react-router-dom"; // Assuming 'NavLink' is not used in this component
import {
  GoogleAuthProvider,
  signInWithPopup,
        ...
        <div className="shadow-lg rounded-md bg-white w-4/5 lg:w-1/3 md:w-2/3 mx-auto ">
          <div className="sm:flex flex-col justify-center md:space-y-0 md:items-center p-4">
            ...
            <div className="w-full p-2 max-w-sm">
              ...
              <PhoneInput country={"in"} value={number} />
              ...
              <div className="border mb-4 border-gray-400 rounded-md cursor-pointer flex items-center justify-center">
                ...
                >
                  <g clip-path="url(#clip0_417_11700)">
                    <path
                      d="M23.9885 13.2642C23.9885 12.2579 23.9069 11.5235 23.7301 10.762H12.239V15.304H18.984C18.8481 16.4327 18.1138 18.1326 16.4819 19.2749L16.459 19.4269L20.0923 22.2416L20.344 22.2667C22.6558 20.1316 23.9885 16.9903 23.9885 13.2642Z"
                      fill="#4285F4"
                    />
                    <path
                      d="M12.239 25.2313C15.5435 25.2313 18.3177 24.1433 20.344 22.2667L16.4819 19.2749C15.4484 19.9956 14.0612 20.4988 12.239 20.4988C9.00248 20.4988 6.25551 18.3638 5.27629 15.4128L5.13276 15.425L1.35483 18.3488L1.30542 18.4862C3.31804 22.4842 7.45214 25.2313 12.239 25.2313Z"
                      fill="#34A853"
                    />
                    <path
                      d="M5.27634 15.4128C5.01797 14.6513 4.86844 13.8353 4.86844 12.9922C4.86844 12.149 5.01797 11.3331 5.26275 10.5716L5.25591 10.4094L1.43062 7.43863L1.30547 7.49816C0.475969 9.15725 0 11.0203 0 12.9922C0 14.964 0.475969 16.827 1.30547 18.4861L5.27634 15.4128Z"
                      fill="#FBBC05"
                    />
                    <path
                      d="M12.239 5.48555C14.5372 5.48555 16.0875 6.47827 16.9714 7.30786L20.4255 3.9353C18.3042 1.96346 15.5435 0.753143 12.239 0.753143C7.45214 0.753143 3.31804 3.50011 1.30542 7.49817L5.2627 10.5716C6.25551 7.62061 9.00248 5.48555 12.239 5.48555Z"
                      fill="#EB4335"
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0_417_11700">
                      <rect
                        ...
                        height="24.5625"
                        fill="white"
                        transform="translate(0 0.753143)"
                      />
                    </clipPath>
                  </defs>
                </svg>
                  ...
                  <defs>
                    <clipPath id="clip0_417_11708">
                      <rect
                        ...
                        height="24"
                        fill="white"
                        transform="translate(0 0.315643)"
                      />
                    </clipPath>
                  </defs>
                </svg>
