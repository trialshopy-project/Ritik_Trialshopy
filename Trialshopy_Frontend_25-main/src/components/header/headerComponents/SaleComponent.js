...
const SaleComponent = ({ categoryId }) => {
	const [selectedSubCat, setSelectedSubCat] = useState(
		'64cfdf8760cdd1ff4c95d10c'
	);
	...
	return (
		<div className="w-full bg-white z-20 absolute top-0 grid lg:grid-cols-5 grid-cols-2 grid-rows-3 lg:grid-rows-1 gap-4 lg:px-[5rem] md:px-10 px-3 py-5 border rounded shadow-lg">
			<div className="flex flex-col border-r">
				<div className="my-1 font-semibold">Up To 50% OFF</div>
				<div className="my-1 h-[2px] w-1/4 bg-gray-400 rounded"></div>
