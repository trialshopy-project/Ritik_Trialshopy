...
const JewelleryComponent = ({ categoryId }) => {
	const [selectedSubCat, setSelectedSubCat] = useState(
		'64bf95c1d330d15fd84494ce'
	);
	...
	return (
		<div className="w-full bg-white z-100 absolute top-0 grid lg:grid-cols-5 grid-cols-2 grid-rows-3 lg:grid-rows-1 gap-4 lg:px-[5rem] md:px-10 px-3 py-5 border rounded shadow-lg">
			...
			{/* <div className="col-span-2 md:col-span-1 flex flex-row items-center justify-center w-fit h-full shadow-md hover:shadow-lg p-2 rounded">
