...
function ShopNowCard2({products}) {
          ...
          {(products&&products.length>0) ? (
              ...
              <div className="grid grid-cols-2 gap-5 lg:grid-cols-4 md:grid-col-4">
                {products.map((liveDemoProduct, index) => {
                  ...
                  return (
                    <div key={index} className="w-full max-w-72 min-h-64 h-auto">
                      <div className="relative block w-full ">
                        ...
                        >
                          <img
                            ...
                            className="block min-w-[80px] w-full h-[200px] xl:h-[256px] lg:h-[200px] md:h-[20vh]"
                          />
                        </Link>
                      ...
                      <div className="flex flex-col w-full gap-2 mt-2 item-center">
                        ...
                        <div className="font-poppins text-[7px] leading-11 text-left">
                          <div className="flex justify-between items-center text-[#7C7C7C]">
                            ...
                            <div className="ml-1 text-green-600 font-semibold text-[12px] sm:text-xs lg:text-sm leading-9.66">
                              ({discount}% off)
                            </div>
                          </div>
                        </div>
