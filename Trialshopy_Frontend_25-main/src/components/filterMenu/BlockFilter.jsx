...
const BlockFilter = ({ setSelectedFilters }) => {
	...
	const handleSearchChange = (e) => {
		...
		blockNames.filter((block) => {
			if (block.toLowerCase().includes(e.target.value.toLowerCase())) {
				handleFilterClick(block);
			}
		})
	};
	...
	const handleFilterClick = (block) => {
		setBlockSelected(block);
		setSelectedFilters({ blockSelected: block });
	};
