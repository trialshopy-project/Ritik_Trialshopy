  ...
  return (
    <>
      <div className="flex flex-row justify-center w-full ">
        <div className="w-60 md:w-56 relative h-fit items-center bg-gray-200 flex my-12  ">
          <div className="w-60 md:w-56">
            <video width={"320"} src={src} ref={videoRef} className="w-60 md:w-56 rounded shadow-md shadow-black" />
            <div className="absolute   flex flex-col  items-center justify-end gap-1 pb-2   bottom-0 -right-12 sm:gap-3">
              <div className="flex flex-col gap-1 ">
                {alreadyLiked||like ? (
                  <div className=" flex items-center w-8 h-8 bg-white rounded-full sm:bg-gray-400">
                    <AiFillLike
                      className=" w-10 text-xl text-blue-500"
                      onClick={() => {
                        handleLike();
                      }}
                    />
              ...
              >
                <div className="flex items-center w-8 h-8 bg-white rounded-full sm:bg-gray-400">
                  <BiCommentDetail className="w-10 text-xl" />
                </div>
              ...
              >
                <div className="flex items-center w-8 h-8 bg-white rounded-full sm:bg-gray-400">
                  <FaShare className="w-10 text-xl" />
          ...
          <div className="flex mt-2 ">
            ...
            {mute ? (
              ...
              <VscUnmute
                className="absolute text-xl text-white h-9 top-2 right-1 "
                onClick={() => {
                  setMute(true);
          ...
          {comment && (
            <CommentBox comment={comment} setComment={setComment} data={data.comments} reelID={data._id} reel={data} fetchReels={fetchReels}/>
          )}
